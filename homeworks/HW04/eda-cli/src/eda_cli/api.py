...
async def quality_flags_from_csv(file: UploadFile = File(...)) -> QualityFlagsResponse:
    ...
    flag = {}
    flag["too_few_rows"] = flags_all["too_few_rows"]
    flag["too_many_missing"]= flags_all["too_many_missing"]
    flag["too_many_columns"]= flags_all["too_many_columns"]
    flag["has_constant_columns"]= flags_all["has_constant_columns"]
    flag["has_suspicious_id_duplicates"]= flags_all["has_suspicious_id_duplicates"]
    
    return QualityFlagsResponse(flags=flag)
